...
const FAQCompo = ({title, content}) => {
  ...
  return (
        <div className='flex flex-col mx-auto border-b border-black w-[90%] max-w-[75rem] mb-6 transition duration-200'>
            <div onClick={()=>{setIsActive(!isActive)}} className='flex justify-between min-w-[90%] items-center mb-6'>
                ...
                <div className='cursor-pointer w-12 flex justify-end'><img src={!isActive? plus : minus} alt="Plus" className='w-4 h-12' /></div>
            </div>
            {isActive && (
