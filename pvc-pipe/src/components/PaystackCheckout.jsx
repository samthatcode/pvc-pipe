...
const PaystackCheckout = () => {
    ...
    return (
        <div className='mt-2'>
            <h1 className="mb-2 text-xl my-4">Checkout</h1>
            ...
            <div className="mb-4 flex flex-col">
                    <label
                      htmlFor="name"
                      className="my-2 text-lg text-[#80978E]"
                    >
                      Amount to pay
                    </label>
                    <input
                  ...
                  { <PaystackConsumer {...componentProps}>
                        {({initializePayment}) => <button 
                            onClick={(e) => {e.preventDefault(); initializePayment(handlePaystackSuccessAction, handlePaystackCloseAction)}}
