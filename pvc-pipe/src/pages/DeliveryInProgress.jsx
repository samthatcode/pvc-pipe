  ...
  return (
    <>
      ...
      {/* <div className=" m-7 grid grid-cols-1 gap-4 md:grid-cols-2  lg:grid-cols-3">
          ...
          <div className="m-7 ">
            <div for="phone" className="">
              <label class=" mr-2 text-sm font-medium text-slate-700">
                PHONE NO:
              </label>
              <br />
              <input
